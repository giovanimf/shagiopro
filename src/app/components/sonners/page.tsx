                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>A simple toast with title and description.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Button
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Displays a success notification.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Button
                                onClick={() =>
                            ...
                            <Button
                                onClick={() =>
                                    toast.error("An error occurred while processing your request.", {
                                        className: "bg-destructive/10 border border-destructive text-destructive"
                                    })
                                }
                            >
                                Show Error Toast
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <Button
                                onClick={() =>
                                    toast("Item deleted.", {
                                        className: "bg-secondary/10 border border-secondary text-secondary",
                                        action: {
                                            label: "Undo",
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Useful for more detailed messages.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Button
                                onClick={() =>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Adds a custom icon to the toast.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Button
                                onClick={() =>
                                    toast("Important warning!", {
                                        ...
                                        className: "pl-4 bg-secondary/10 border border-secondary text-secondary"
                                    })
                                }
                            >
                                Show Icon Toast
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Disappears automatically after 10 seconds.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Button
                                onClick={() =>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Shows a loading toast followed by a success toast.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Button
                                onClick={() => {
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Change the position directly in the layout or via context.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Button
                                onClick={() =>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Does not close automatically; requires user action.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Button
                                onClick={() =>
